   ...
   $(document).ready(function() {
       ...
       document.getElementById("request_number").value = "REQ-" + random;
   });
...
$(".btn-warning").click(function(){
   ...
   var costcenterID;
    ...
    $(document).ready(function() {
        var type;
          $('#invoice_type').on('change.datepickerreturndate', function() {
           type = $(this).val();
           console.log(type);
            if(type == 'S'){
              $('#return').hide();
              document.getElementById("invoice_typemov").value = "Saída";
              $('#datepickerdatemov').on('change.datepickerreturndate', function() {
              var returndate=  document.getElementById("datepickerdatemov").value;
              document.getElementById("datepickerreturndate").value = returndate;
              var log=  document.getElementById("datepickerreturndate").value;
              console.log(log);
            });
            }else{
                $('#return').show();
                document.getElementById("invoice_typemov").value = "Empréstimo";
            }
          }).trigger('change.datepickerreturndate');
        });
