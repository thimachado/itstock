...
<div class="box box-info">
   ...
   <form class="form-horizontal" method="POST" action="{{ url('/savedomainedit') }}">
      {{ csrf_field() }}
      ...
      <div class="box-body">
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_name') ? 'has-error' : '' }}">
                  <input type="text" name="domain_name" class="form-control" value="{{$details->domain_name}}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_holder') ? 'has-error' : '' }}">
                  <input type="text" name="domain_holder" class="form-control" value="{{$details->domain_holder}}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_owner') ? 'has-error' : '' }}">
                  <input type="text" name="domain_owner" class="form-control" value="{{$details->domain_owner}}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_userlogin') ? 'has-error' : '' }}">
                  <input type="text" name="domain_userlogin" class="form-control" value="{{$details->domain_userlogin}}"  required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_emaillogin') ? 'has-error' : '' }}">
                  <input type="email" name="domain_emaillogin" class="form-control" value="{{$details->domain_emaillogin}}"  required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('domain_password') ? 'has-error' : '' }}">
                  <input type="password" id="password" name="domain_password" class="form-control" value="{{$details->domain_password}}" required autofocus>
         ...
         <div class="form-group">
               ...
               <div class="col-sm-8">
                  <div class="form-group has-feedback {{ $errors->has('domain_createdat') ? 'has-error' : '' }}">
                     <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepickercreatedat" name="domain_createdat" value="{{$details->domain_createdat}}">
               ...
               <div class="col-sm-8">
                  <div class="form-group has-feedback {{ $errors->has('domain_expireat') ? 'has-error' : '' }}">
                     <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepickerexpireat" name="domain_expireat" value="{{$details->domain_expireat}}">
               ...
               <div class="col-sm-8">
                  <div class="form-group has-feedback {{ $errors->has('domain_updatedat') ? 'has-error' : '' }}">
                     <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepickerupdatedat" name="domain_updatedat"  value="{{$details->domain_updatedat}}">
            ...
            <div class="col-sm-8">
               ...
               <textarea name= "domain_observation" class="form-control" rows="3" placeholder="Você pode deixar em branco...">{{$details->domain_observation}}</textarea>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('domain_status') ? 'has-error' : '' }}">
               <select name="domain_status" id="domain_status" class="form-control" required autofocus> 
                  <option value="{{$details->domain_status}}">{{$details->domain_status}}</option>
