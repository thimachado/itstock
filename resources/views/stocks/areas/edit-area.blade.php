...
<form class="form-horizontal" method="POST" action="{{ url('/saveareaedit') }}">
      {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('area_name') ? 'has-error' : '' }}">
                  <input type="text" name="area_name" class="form-control" value="{{ $details->area_name}}" required autofocus>
                  @endforeach
