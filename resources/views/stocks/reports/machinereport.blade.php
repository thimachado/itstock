...
@section('title', 'HB Estoque Relatório de Máquinas em Estoque')
@section('content_header')
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.5.2/css/buttons.dataTables.min.css">
<h1>HB Estoque Relatório de Máquinas em Estoque</h1>
@stop
@section('content')
<div class="box box-info">
<div class="box">
   <div class="box-header">
      <h3 class="box-title">Relatório de Máquinas em Estoque</h3>
      <div class="box-tools">
      </div>
   </div>
   <!-- /.box-header -->
