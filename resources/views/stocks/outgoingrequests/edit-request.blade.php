...
<!-- form start -->
<div class="box-body">
<form class="form-horizontal" method="POST" action="{{ url('/saveoutgoingrequestedit') }}">
   <div class="row">
   <div class="col-sm-6">
      {{ csrf_field() }}
      @foreach($data as $details)
      <input type="hidden" value="{{$details->invoice_number}}" id="request_number" name="request_number">
      <input type="hidden" value="S" id="invoice_type" name="invoice_type">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_type') ? 'has-error' : '' }}">
               <select name="invoice_typeshow" class="form-control"disabled >
                  <option value="S">{{$details->invoice_typemov}}</option>
               </select>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('request_number') ? 'has-error' : '' }}">
               <input type="text"  id="request_number" name="request_number"  class="form-control" value="{{$details->invoice_number}}" required disabled>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('request_owner') ? 'has-error' : '' }}">
               <input type="text"  id="request_owner" name="request_owner"  class="form-control"  value="{{$details->invoice_owner}}" required autofocus>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('request_observation') ? 'has-error' : '' }}">
               <textarea name= "request_observation" class="form-control" rows="3" placeholder="Você pode deixar em branco..."> {{$details->request_observation}}</textarea>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('request_datemov') ? 'has-error' : '' }}">
               <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerdatemov" name="request_datemov" value="{{$details->invoice_billingdate}}">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('request_returndate') ? 'has-error' : '' }}">
               <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerreturndate" name="request_returndate" value="{{$details->invoice_duedate}}">
               </div>
            </div>
         </div>
      </div>
...
<script src="{{ URL::asset('js/editrequest.js') }}"></script>
