...
@section('title', 'HB Estoque Histórico de Saída')
...
<div class="box box-info">
   <div class="box-header with-border">
      <h3 class="box-title">Última Requisição de Saída Registrada</h3>
   </div>
<div class="box-body">
          <!-- /.box-header -->
...
<div class="box">
   <div class="box-header">
      <h3 class="box-title"> Histórico de Requisições de Saída</h3>
      <div class="box-tools">
      </div>
   </div>
   <!-- /.box-header -->
