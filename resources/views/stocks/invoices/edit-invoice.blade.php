...
<form class="form-horizontal" method="POST" action="{{ url('/saveinvoiceedit') }}">
   <input type="hidden" value="{{$details->invoice_number}}" id="invoice_id" name="invoice_id">
   <input type="hidden" value="E" id="invoice_type" name="invoice_type">
   <input type="hidden" value="{{$details->invoice_typemov}}" id="invoice_typemov" name="invoice_typemov">
   <div class="row">
   <div class="col-sm-6">
      {{ csrf_field() }}
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_type') ? 'has-error' : '' }}">
               <select name="invoice_typeshow" class="form-control" disabled>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_typemov') ? 'has-error' : '' }}">
               <select id="invoice_typemov" name="invoice_typemovshow" class="form-control" disabled>
                  <option value="{{$details->invoice_typemov}}">{{$details->invoice_typemov}}</option>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_number') ? 'has-error' : '' }}">
               <input type="text"  id="invoice_number" name="invoice_number"  class="form-control" value="{{$details->invoice_number}}" required autofocus >
      ...
      <div class="form-group">
         @foreach($data as $details)
         <label for="inputEmail3" class="col-sm-2 control-label">Área {{$details->area_name}}</label>
         <div class="col-sm-8">
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('costcenter_description') ? 'has-error' : '' }}">
               ...
               @foreach($data as $details)
               <option value="{{$details->costcenter_id}}">{{$details->costcenter_description}}</option>
               @endforeach
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_owner') ? 'has-error' : '' }}">
               <input type="text"  id="invoice_owner" name="invoice_owner"  class="form-control" value="{{$details->invoice_owner}}" required autofocus>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_ctafin') ? 'has-error' : '' }}">
               <input type="text"  id="invoice_ctafin" name="invoice_ctafin"  class="form-control" value="{{$details->invoice_ctafin}}" required autofocus>
      ...
      <div class="form-group">
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_ctacon') ? 'has-error' : '' }}">
               <input type="text"  id="invoice_ctacon" name="invoice_ctacon"  class="form-control" value="{{$details->invoice_ctacon}}" required autofocus>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('deposit_name') ? 'has-error' : '' }}">
               <select id="deposit_id" type="text" class="form-control" name="deposit_id" required>
                  <option value="{{$details->deposit_id}}">{{$details->deposit_name}}</option>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_billingdate') ? 'has-error' : '' }}">
               <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerbill" name="invoice_billingdate" value="{{$details->invoice_billingdate}}">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="col-sm-8">
            <div class="form-group has-feedback {{ $errors->has('invoice_duedate') ? 'has-error' : '' }}">
               <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepickerdue" name="invoice_duedate" value="{{$details->invoice_duedate}}">
               </div>
            </div>
         </div>
      </div>
