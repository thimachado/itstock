...
<form class="form-horizontal" method="POST" action="{{ url('/savebusinessedit') }}">
      {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('business_name') ? 'has-error' : '' }}">
                  <input type="text" name="business_name" class="form-control" value="{{ $details->business_name}}" required autofocus>
                  @endforeach
