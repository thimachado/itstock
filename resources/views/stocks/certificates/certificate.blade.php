...
<div class="box box-info">
   ...
   <!-- /.box-header -->
   <!-- form start -->
   <form class="form-horizontal" method="POST" action="{{ url('/savecertificate') }}">
      {{ csrf_field() }}
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('certificate_emitter') ? 'has-error' : '' }}">
                  <input type="text" name="certificate_emitter" class="form-control" value="{{ old('certificate_emitter') }}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('certificate_owner') ? 'has-error' : '' }}">
                  <input type="text" name="certificate_owner" class="form-control" value="{{ old('certificate_owner') }}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('certificate_value') ? 'has-error' : '' }}">
                  <input type="text" name="certificate_value" class="form-control" value="{{ old('certificate_value') }}" required autofocus>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               <div class="form-group has-feedback {{ $errors->has('certificate_use') ? 'has-error' : '' }}">
                  <input type="text" name="certificate_use" class="form-control" value="{{ old('certificate_use') }}" required autofocus placeholder="Informe o produto, projeto ou setor em que é o certificado é utilizado.">
               ...
               <div class="col-sm-8">
                  <div class="form-group has-feedback {{ $errors->has('certificate_expirationdate') ? 'has-error' : '' }}">
                     <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="datepickerexpireat" name="certificate_expirationdate">
